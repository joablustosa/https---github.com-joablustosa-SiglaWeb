...
@Component({
  selector: 'app-coordenacao-cadastro-area-responsavel',
  templateUrl: './coordenacao-cadastro-area-responsavel.component.html',
  styleUrls: ['./coordenacao-cadastro-area-responsavel.component.css']
})
export class CoordenacaoCadastroAreaResponsavelComponent implements OnInit {
